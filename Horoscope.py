next = True
while(next == True):
    print(''' From all the mentioned Zodiacs
    1)Aries
    2)Tauras
    3)Gemini
    4)Cancer
    ...
    s = int(input("Pick your sign and Press Enter to know your future.\n"))
    print(s)
    if s == 1:
        print(
        ...
        print(
            "Bosses will assign new responsibilities to you, predicts Ganesha. Your daytime distress, however, will transform into jubilation by the end of the day's work, as you will be able to produce brilliant results. Ganesha advises you to delay bidding for tenders by a few days.")
    elif s == 4:
        print(
        ...
        print(
            "You shall probably realise the fact that seeing is believing. Learn to trust your own eyes more than what you hear. Don't get lost in the crowd, warns Ganesha. Strive to stand out and be in the spotlight, advises Ganesha.")
    elif s == 9:
        print(
        ...
        print(
            "Duping the wisest with your extraordinary power of convincing may have been your forte, but you may have to prove yourself all over again, for Ganesha says you will be tested today. This apart, you are likely to find answers to questions lingering in your subconscious mind for long. The outburst of creativity in the second half of the day will draw the attention of your peers, and this will also be the best time to seek their support, advises Ganesha.")
    elif s == 11:
        print(
            "For a moment, it seems that you're swamped with problems. But you are brave enough to deal with any ugly issue that crops up suddenly. Ganesha hints at a romantic evening, which may just be time together in a jacuzzi, or simply preparing a meal together. Pure ecstasy!")
    elif s == 12:
        print(
